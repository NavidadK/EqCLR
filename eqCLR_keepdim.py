...
for seed in [0, 1, 2]:
    for N in [1, 2, 4, 6, 8, 10, 12, 16]:
        ...
        model = EqResNet18(N=N, maxpool=MAXPOOL, projector_hidden_size=PROJECTOR_HIDDEN_SIZE, n_classes=PROJECTOR_OUTPUT_SIZE, adjust_channels='keep_param')
        ...
        with open(f'{folder}/model_eval_rotations/{MODEL_FILENAME}_rotation_eval.pkl', 'wb') as f:
